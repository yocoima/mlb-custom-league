...
function snapshot(){
  return {
    ...
    config:{username:"commissioner",platform:"psn",myTeam:"Tigers",startDate:"2026-08-15",regulationInnings:5,maxPages:40,proxyBase:"https://worker.example",roster:{commissioner:"Tigers",friend:"Blue Jays"}},
